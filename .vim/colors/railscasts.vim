...
highlight IncSearch                 guifg=NONE guibg=#2b2b2b ctermfg=yellow ctermbg=black gui=italic cterm=underline
highlight Search                    guifg=NONE guibg=#2b2b2b ctermfg=yellow ctermbg=black gui=italic cterm=underline
